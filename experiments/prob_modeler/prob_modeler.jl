...
# ╔═╡ 26fef4c0-24e0-11ec-1489-63ebf1129c5a
begin
	using Pkg 
	using DataFrames 
	using Pandas 
...
# ╔═╡ 95828e18-81cc-45f0-8324-1f1f998ffcfa
# Shortcut: https://github.com/fonsp/Pluto.jl/issues/65#issue-595782206


# ╔═╡ 7fccc5ce-3954-4f5c-a49e-01df9eb20e56
begin
	scriptdir = cd(pwd, "../..") 
...
# ╔═╡ 72d25b70-822d-477b-a024-07d3d5324fed
begin
	dd = es.com_survey_df()
	kk = es.com_key_df()
...
# ╔═╡ b4734ec6-00dc-4e44-ad29-0986207d2472
begin
	regions = kk[3, 7]
	bldtypes = kk[4, 7] 
...
# ╔═╡ 2a6df6ea-0baf-4772-bb98-3d019b716ad7
begin
	q_arr = dd[:, [:pba, :heat, :finalwt]]
	N = sum(q_arr[:, :finalwt])
	@show N;
	#q_arr[1:5, :]
end

# ╔═╡ c1735440-480c-4ced-98c9-651f26eacdf2
"""
...
# ╔═╡ d245cc8e-3a5a-473e-96af-3f7eca32546c
